...
import { getEmployeeByIDAPI, updateAdminAPI } from "../Services/AdminAPIService";
  ...
  useEffect(() => {
    async function fetchEmployeeData() {
      ...
      if (response.ok) {
        ...
        setAnniversary(new Date(employee.anniversary));
        setManagerID(employee.manager ? employee.manager.managerID : 0); // Check if manager is not null
        setPerformanceReview(employee.performanceReview);
        setLeave(employee.leaves);
