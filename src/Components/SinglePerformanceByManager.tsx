...
export function PerformanceReviewEntry(props: myPerformanceProps) {
    ...
    return (
        ...
        <div className="perform-div">
            <label className="perform-label">Employee Name: {/*props.data.employee.name*/}</label>
        </div>
        <div className="perform-div">
	        <label className="perform-label">Goal:</label> {props.data.goalType}
            <br></br>
            <label className="perform-label">Weight: </label>{props.data.weight}
            <br></br>
        ...
        <div className="perform-div">
            <label className="perform-label">Manager Comments: </label>{props.data.managerComments}
            <br></br>
